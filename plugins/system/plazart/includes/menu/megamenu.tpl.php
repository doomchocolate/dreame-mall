...
*/
	...
	static function item_url ($vars) {
		...
		switch ($item->browserNav) :
			...
			case 1:
				// _blank
				$link = "<a class=\"$class\" href=\"$flink\" target=\"_blank\" $title $dropdown>$icon$linktype </a>$caret";
				break;
			case 2:
				// window.open
				$options = 'toolbar=no,location=no,status=no,menubar=no,scrollbars=yes,resizable=yes';
				$link = "<a class=\"$class\" href=\"$flink\" onclick=\"window.open(this.href,'targetWindow','$options');return false;\" $title $dropdown>$icon$linktype </a>$caret";
				break;
		endswitch;
	...
	static function item_component ($vars) {
		...
		switch ($item->browserNav) :
			default:
			case 0:
				$link = "<a class=\"$class\" href=\"{$flink}\" $title $dropdown>$icon$linktype </a>$caret";
				break;
			case 1:
				// _blank
				$link = "<a class=\"$class\" href=\"{$flink}\" target=\"_blank\" $title $dropdown>$icon$linktype </a>$caret";
			...
			case 2:
			// window.open
				$link = "<a class=\"$class\" href=\"{$flink}\" onclick=\"window.open(this.href,'targetWindow','toolbar=no,location=no,status=no,menubar=no,scrollbars=yes,resizable=yes');return false;\" $title $dropdown>$icon$linktype </a>$caret";
				break;
		endswitch;
