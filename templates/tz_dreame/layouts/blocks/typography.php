                                    ...
                                    <div id="tz-typography">
                                        ...
                                        <div class="row-fluid">
                                            <div class="span12">
                                                <div class="accordion accordion-style2" id="accordion2">
                                                    <div class="accordion-group">
                                                        <div class="accordion-heading bg-dark-light">
                                        ...
                                        <div class="row-fluid">
                                            <div class="span12">
                                                ...
                                                <div class="skill">
                                                    <div class="row-fluid bg-gray"><i class="icon-mobile-phone size28"></i>IOS development - 90%</div>
                                                    <div class="progress progress-danger"> 
                                                        <div class="bar bg-orange" style="width: 90%"></div>
                                                    </div>
                                                    <div class="row-fluid bg-gray"><i class="icon-film size22"></i>Video Player- 70%</div>
                                                    <div class="progress progress-danger"> 
                                                        <div class="bar bg-orange" style="width: 70%"></div>
                                                    </div>
                                                    <div class="row-fluid bg-gray"><i class="icon-search size22"></i>Search Processing - 70%</div>
                                                    <div class="progress progress-danger"> 
                                                        <div class="bar bg-orange" style="width: 70%"></div>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="row-fluid">
                                            ...
                                            <div class="span4 first">
                                                <ul class="nav nav-tabs myTab tab-gray-light" id="myTab">
                                        ...
                                        <div class="row-fluid">
                                            ...
                                            <div class="span7">
                                                <h2>Popover</h2>
                                                <div class="popovers">
                                                    Vestibulum lorem diam, placerat non erat id, accumsan pretium urna. Cras blandit cursus metus. Donec eget gravida sem. Proin sollicitudin mi nulla, at vehicula orci tempus sed.<a title="" data-content="Vivamus sagittis lacus vel augue laoreet rutrum faucibus." data-placement="top" data-toggle="popover"  href="#" data-original-title="Popover on top">Popover on top</a>Donec eget consequat diam. Sed cursus lobortis neque, vitae rutrum neque elementum nec. Proin sed viverra odio.
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row-fluid tz-table">
                                            <div class="span3 tz-column column-first">
                                                ...
                                                <ul class="table-content">
                                                    <li>Mikado, the spiritual Emperor </li>
                                                    <li class="bg-light">Mikado, the spiritual Emperor </li>
                                                    <li>Mikado, the spiritual Emperor </li>
                                                    <li class="bg-light">Mikado, the spiritual Emperor </li>
                                                    <li>Mikado, the spiritual Emperor </li>
                                                </ul>
                                            ...
                                            <div class="span3 tz-column">
                                                ...
                                                <ul class="table-content">
                                                    <li>Mikado, the spiritual Emperor </li>
                                                    <li class="bg-light">Mikado, the spiritual Emperor </li>
                                                    <li>Mikado, the spiritual Empero </li>
                                                    <li class="bg-light">Mikado, the spiritual Emperor </li>
                                                    <li>Mikado, the spiritual Emperor </li>
                                                </ul>
                                            </div>
