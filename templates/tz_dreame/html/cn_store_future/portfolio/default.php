...
<?php if($this -> listsProduct):?>
    ...
    <script type="text/javascript">
        function tz_init(defaultwidth){
            ...
            var mediatype = jQuery('.TzInner').find('div').hasClass('.TZPorfolioMedium');
    ...
    <div id="TzContent">
        ...
        <div id="tz_options" class="clearfix">
            ...
            <div class="option-combo">
                <h3 class="TzFilter"><?php echo JText::_('COM_TZ_PORTFOLIO_FILTER_TPL');?></h3>


                <div id="filter" class="option-set clearfix" data-option-key="filter">
                    <a href="#show-all" data-option-value="*" class=" selected"><?php echo JText::_('COM_TZ_PORTFOLIO_SHOW_ALL');?></a>
            ...
            <?php if($params -> get('show_sort',1)):?>
                <div class="option-combo">
                  <h3><?php echo JText::_('COM_TZ_PORTFOLIO_SORT')?></h3>
                  <div id="sort" class="option-set clearfix" data-option-key="sortBy">
                      <a class="" href="#title" data-option-value="name"><?php echo JText::_('COM_TZ_PORTFOLIO_TITLE');?></a>
                      <a class="selected" href="#date" data-option-value="date"><?php echo JText::_('COM_TZ_PORTFOLIO_DATE');?></a>
                  </div>
                </div>
            <?php endif;?>
            ...
            <?php if($params -> get('show_layout',1)):?>
                <div class="option-combo">
                    <h3><?php echo JText::_('COM_TZ_PORTFOLIO_LAYOUT');?></h3>
                    ...
                    ?>
                            <a class="<?php if($i == 0) echo ' selected';?>" href="#<?php echo $param?>" data-option-value="<?php echo $param?>">
                                <?php echo $param?>
                            </a>
                        <?php endforeach;?>
                    <?php endif;?>
...
<script type="text/javascript">
    var feature_height = jQuery('.tz_feature_item .tz-media-content').height();
