...
<!--            </h1>-->
        ...
        <?php endif; ?>
            ...
            <?php if ($params->get('show_create_date',1)) : ?>
                <span class="TzCreate">
                <?php echo JText::sprintf(date(JText::_('DATE_FORMAT_LC2_TPL'), strtotime($this->item->created))); ?>
                </span>
            <?php endif; ?>

             <?php if($params -> get('show_vote',1)):?>
                <span class="TzVote">
                    <span class="TzLine"><?php echo JText::_('SPACE_TPL');?></span>
            ...
            <?php if ($params->get('show_author',1) && !empty($this->item->author )) : ?>
                ...
                ?>
                <?php echo JText::sprintf('COM_CONTENT_WRITTEN_BY_TPL', JHtml::_('link', JRoute::_($cntlink), $author,$target)); ?>
                <?php else: ?>
                    <?php echo JText::sprintf('COM_CONTENT_WRITTEN_BY_TPL', $author); ?>
                <?php endif; ?>
                </span>
            <?php endif; ?>
            ...
            <span class="TzArticleCategory">
                ...
                <?php if ($params->get('link_category',1) and $this->item->catslug) : ?>
                    <?php echo JText::sprintf('COM_CONTENT_CATEGORY_TPL', $url); ?>
                <?php else : ?>
                    <?php echo JText::sprintf('COM_CONTENT_CATEGORY_TPL', $title); ?>
                <?php endif; ?>
            </span>
            <?php endif; ?>
    ...
    <?php if ($params->get('access-view')):?>
        ...
        <?php
            require_once($templateDir.DIRECTORY_SEPARATOR.'html'.DIRECTORY_SEPARATOR.'com_tz_portfolio'.DIRECTORY_SEPARATOR.'users'.DIRECTORY_SEPARATOR.'default_author.php');
        ?>
