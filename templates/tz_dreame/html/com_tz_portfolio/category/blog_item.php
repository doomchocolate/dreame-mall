...
<?php if( (isset($listMedia[0] -> type) AND $listMedia[0] -> type != 'quote'
    ...
    <?php if ($params->get('show_create_date')) : ?>
        <span class="TzBlogCreate">
              <?php echo JText::sprintf('COM_CONTENT_WRITTEN_BY_BLOG_TPL', JHtml::_('date', $this->item->created, JText::_('DATE_FORMAT_LC2_BLOG_TPL'))); ?>
            </span>
    <?php endif; ?>
