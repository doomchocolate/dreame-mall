...
$imgSize    = null;
$src        = null;
if(isset($media[0]->images)){

    $src_test    = str_replace('.'.JFile::getExt($media[0] -> images),'_M'
        .'.'.JFile::getExt($media[0] -> images),$media[0] -> images);


    $imageProperties = JImage::getImageFileProperties($src_test);
...
<?php if($params -> get('show_image') OR $params -> get('show_image_gallery') OR $params -> get('show_video')):?>
    <?php if($media):?>
        ...
        <div class="TzPortfolioMedia <?php if($feature !=1 && $ratio > 0.75){ echo "TZPorfolioMedium"; } ?>">
