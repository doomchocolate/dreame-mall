...
<?php if($lists):?>
    <div class="TzTag TzBlog">
        <div class="TzTagInner TzBlogInner">
                    ...
                    <div class="<?php if($i == 0): echo 'TzItemsLeading'; else: echo 'TzItemsRow row-0'; endif;?>">
                        <div class="span12 leading-0">
                            ...
                            <?php if (($params->get('show_author')) or ($params->get('show_category')) or ($params->get('show_create_date')) or ($params->get('show_modify_date')) or ($params->get('show_publish_date')) or ($params->get('show_parent_category')) or ($params->get('show_hits'))) : ?>
                                <div class="TzTagArticleInfo TzArticleBlogInfo">
                            <?php endif; ?>
                            ...
                            <?php if($params -> get('show_title')): ?>
                                <h3 class="TzTagTitle TzBlogTitle">
                            ...
                            ?>
                                <?php if($params -> get('show_readmore',1) == 1):?>
                                    <a class="btn btn-medium bg-orange <?php if($params -> get('tz_use_lightbox') == 1){echo ' fancybox fancybox.iframe';}?>"
                                       href="<?php echo $link; ?>">
